...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <tr>
                            <tr>
                                <td><?php echo '<img id="my" height="150" width="150"src="'.BASE_URL.'assets/upload/cover/'.$row["book_image"].'" />'; ?></td>
                                ...
                                <td>
                                    <a href="<?php echo ADMIN_PATH; ?>book_edit.php?id=<?php echo $row['book_id']; ?>" title="Edit"><i class="fas fa-edit"></i></a>
