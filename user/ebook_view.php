                        ...
                        while ($row = mysqli_fetch_assoc($query)) {
                            ...
                            <div class="col-md-12">
                                <div class="ereaders-book-wrap">
                                    <div class="row">
                                        <div class="col-md-5">
                                            <img src="<?php echo BASE_URL;?>assets/upload/cover/<?php echo $row["ebook_image"]; ?>" alt="" class="img-thumb">
                                        </div>
                                        <div class="col-md-7">
                                ...
                                <div class="ereaders-books ereaders-book-grid ereaders-book-related">
                                    <ul class="row">
                                        ...
                                        $query = "SELECT * FROM ebooks WHERE book_section = '$sec' AND book_location = '$loc' ";
